 ...
 * two logos are byte-for-byte copies of the owner-provided originals
...
test('the logos keep the original dimensions — 1063×345 and 1305×200 (UI-17, UI-18)', function () {
    foreach (expectedBrandAssets() as $path => $expected) {
...
test('the logos are byte-for-byte copies of the originals — same size and sha256 (UI-19, IH-02)', function () {
    foreach (expectedBrandAssets() as $path => $expected) {
